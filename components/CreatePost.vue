        ...
        <div class="py-2 w-full ">
          <div class="flex items-center">
            <div class="flex items-center text-white">
              <img class="rounded-full h-[35px]" src="https://picsum.photos/id/237/50" />
              <div class="ml-2 font-semibold text-[18px]"> Jony Week  </div>
            </div>
          </div>
          ...
          <div class="relative flex items-center w-full">
            ...
            <div class="bg-black rounded-lg w-[calc(100%-50px)] text-full font-light">
